...
function simplifyObject(webcastObject) {
  ...
  if (webcastObject.emotes) {
    webcastObject.emotes = webcastObject.emotes.map(x => {
      var _x$emote, _x$emote2;
      return {
        emoteId: (_x$emote = x.emote) === null || _x$emote === void 0 ? void 0 : _x$emote.emoteId,
        emoteImageUrl: (_x$emote2 = x.emote) === null || _x$emote2 === void 0 || (_x$emote2 = _x$emote2.image) === null || _x$emote2 === void 0 ? void 0 : _x$emote2.imageUrl,
  ...
  if (webcastObject.treasureBoxUser) {
    ...
    // holy crap
    Object.assign(webcastObject, getUserAttributes(((_webcastObject$treasu = webcastObject.treasureBoxUser) === null || _webcastObject$treasu === void 0 || (_webcastObject$treasu = _webcastObject$treasu.user2) === null || _webcastObject$treasu === void 0 || (_webcastObject$treasu = _webcastObject$treasu.user3[0]) === null || _webcastObject$treasu === void 0 || (_webcastObject$treasu = _webcastObject$treasu.user4) === null || _webcastObject$treasu === void 0 ? void 0 : _webcastObject$treasu.user) || {}));
...
function getUserAttributes(webcastUser) {
  var _webcastUser$userId, _webcastUser$secUid, _webcastUser$profileP, _webcastUser$followIn, _webcastUser$badges, _webcastUser$createTi, _webcastUser$profileP2, _userAttributes$userB, _userAttributes$userB2, _userAttributes$userB3, _userAttributes$userB4;
  let userAttributes = {
  ...
  userAttributes.topGifterRank = (_userAttributes$userB = (_userAttributes$userB2 = userAttributes.userBadges.find(x => x.url && x.url.includes('/ranklist_top_gifter_'))) === null || _userAttributes$userB2 === void 0 || (_userAttributes$userB2 = _userAttributes$userB2.url.match(/(?<=ranklist_top_gifter_)(\d+)(?=.png)/g)) === null || _userAttributes$userB2 === void 0 ? void 0 : _userAttributes$userB2.map(Number)[0]) !== null && _userAttributes$userB !== void 0 ? _userAttributes$userB : null;
  userAttributes.gifterLevel = ((_userAttributes$userB3 = userAttributes.userBadges.find(x => x.badgeSceneType === 8)) === null || _userAttributes$userB3 === void 0 ? void 0 : _userAttributes$userB3.level) || 0; // BadgeSceneType_UserGrade
  userAttributes.teamMemberLevel = ((_userAttributes$userB4 = userAttributes.userBadges.find(x => x.badgeSceneType === 10)) === null || _userAttributes$userB4 === void 0 ? void 0 : _userAttributes$userB4.level) || 0; // BadgeSceneType_Fans
